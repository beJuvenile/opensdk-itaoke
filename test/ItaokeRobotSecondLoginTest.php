...
use OpenSDK\ITaoKe\Requests\ItaokeRobotSecondLoginRequest;

class ItaokeRobotSecondLoginTest
{
    ...
    public function __invoke()
    {
        ...
        $req = new ItaokeRobotSecondLoginRequest();
...
(new ItaokeRobotSecondLoginTest())();
