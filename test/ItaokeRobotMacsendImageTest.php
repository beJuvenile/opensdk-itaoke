...
use OpenSDK\ITaoKe\Requests\ItaokeRobotMacsendImageRequest;

class ItaokeRobotMacsendImageTest
{
    ...
    public function __invoke()
    {
        ...
        $req = new ItaokeRobotMacsendImageRequest();
        $req->setRobotId('476');
...
(new ItaokeRobotMacsendImageTest())();
